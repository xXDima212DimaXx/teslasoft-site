...
<html>
    ...
    <body>
        ...
        <script>
            function closeAd() {
                document.getElementById('report').style.width = "800px";
                document.getElementById('report').style.zIndex = "6";
                document.getElementById('report-button-1').style.width = "200px";
                document.getElementById('report-button-1').style.height = "90px";
                ...
                document.getElementById('report-button-2').style.width = "200px";
                document.getElementById('report-button-2').style.height = "90px";
                document.getElementById('report-button-2').style.borderRight = "2px solid rgba(255, 255, 255, 0.2)";
                document.getElementById('report-button-2').style.left = "200px";
                document.getElementById('report-button-2').style.position = "fixed";
                document.getElementById('report-button-2').style.opacity = "1";
                document.getElementById('report-button-3').style.width = "200px";
                document.getElementById('report-button-3').style.height = "90px";
                document.getElementById('report-button-3').style.borderRight = "2px solid rgba(255, 255, 255, 0.2)";
                document.getElementById('report-button-3').style.left = "400px";
                document.getElementById('report-button-3').style.position = "fixed";
                document.getElementById('report-button-3').style.opacity = "1";
                document.getElementById('report-button-4').style.width = "200px";
                document.getElementById('report-button-4').style.height = "90px";
                document.getElementById('report-button-4').style.border = "none";
                document.getElementById('report-button-4').style.left = "600px";
            ...
            function reportAd() {
                document.getElementById('adClosed').style.width = "800px";
