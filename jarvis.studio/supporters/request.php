...
<html>
    ...
    <body>
		...
		<div class = "action-bar unselective">
		    ...
		    <b class = "activity-title">Ваша заявка</b>
		    <div class = "ssh">
                        ...
                        <li class = "elem">
                            <ul class = "elemm" style = "margin-left: -30px;" onclick = "javascript:toHome()">
                                <table style = "width: 100%">
                                    <tr>
                                        <td style = "width: 36px; height: 48px; vertical-align: center;">
	    ...
	    <script>
            ...
            requests.on('value',function(orders) {
			    ...
			    orders.forEach(function(firebaseOrderReference) {
				    ...
				    if (reqid == order.Rid && emailu == order.Email) {
				        i = 12345;
					    	...
					    	<div style = "margin: 16px auto; font-size: 16px; line-height: 18px;">
                                <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                                    <div class="mdl-card__title" style = "background: url('https://jarvis.studio/res/images/card`+order.Bg+`_bg.png') center / cover;">
                                        <h2 class="mdl-card__title-text unselective">Ваша заявка</h2>
                                    </div>
                                    <div class="mdl-card__supporting-text">
                                        <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Имя пользователя: ` + order.Username + `</p>
                                        <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Ваш Email: ` + order.Email + `</p>
                                        <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Ваше имя: ` + order.Name + `</p>
		    ...
		    firebase.auth().onAuthStateChanged(function(user) {
                if (user) {
                    ...
                    window.location.replace("https://jarvis.studio/login/oauth?continue=https://jarvis.studio/supporters/request?id=$id");
            ...
            function toLogin() {
                if (isLogged == 1) {
                    ...
                    window.location.assign("https://jarvis.studio/login/oauth?continue=https://jarvis.studio/supporters/request?id=$id");
                }
		    }
