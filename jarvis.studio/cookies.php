...
<html>
    <head>
        <meta charset = "utf-8">
        <title>Jarvis | Детальнее про Cookies</title>
    ...
    <body>
		...
		<div class = "action-bar unselective">
		    ...
		    <b class = "activity-title">Детальнее про Cookies</b>
		    <div class = "ssh">
                    ...
                    <div style = "margin: 16px auto;">
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            <div class="mdl-card__title" id = "card1bg">
                                <h2 class="mdl-card__title-text unselective">Детальнее про Cookies</h2>
                            </div>
                            <div class="mdl-card__supporting-text">
                                <p class = "unselective" style = "color: #ffff00; margin: 8px auto; width: 100%;">Что это такое и для чего нужно?</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Cookies - это временные файлы, которые сохраняются на ваш компьютер для хранения небольших объемов информации.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Например, вы вошли в аккаунт. Но при перезагрузке страницы сессия не была завершена. Все дело в том, что информация о входе сохранилась в файлах Cookies.</p>
                                <p class = "unselective" style = "color: #ffff00; margin: 8px auto; width: 100%;">Для чего мы используем Cookies?</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Хранение информации о входе в аккаунт (Мы ни в коем случае <span style = "color: #db4437">НЕ</span> храним <span style = "color: #ff3d00">имя пользователя</span> и <span style = "color: #ff3d00">пароль</span> в Cookies).</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Аналитика и персонализация (Вы автоматически принимаете <a href = "https://policies.google.com/privacy?fg=1">Политику конфиденциальности и Условия использования Google</a> и <a href = "https://www.tawk.to/privacy-policy/">Политику конфиденциальности tawk.to</a> (<a href = "https://www.tawk.to/">Что это?</a>)).</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Для обеспечения безопасности (Antibot.Cloud, идентификаторы сессий)</p>
                                <p class = "unselective" style = "color: #db4437; margin: 8px auto; width: 100%;">&nbsp;</p>
                                <p class = "unselective" style = "color: #db4437; margin: 8px auto; width: 100%;">МЫ НЕ ИСПОЛЬЗУЕМ COOKIES ДЛЯ ОТСЛЕЖИВАНИЯ ПЕРСОНАЛЬНЫХ ДАННЫХ ПОЛЬЗОВАТЕЛЯ ТАКИХ, КАК IP АДРЕСА, ТОЧНОЕ МЕСТОРАСПОЛОЖЕНИЕ, ПАРОЛИ, ДАТУ РОЖДЕНИЯ, НАСТОЯЩЕЕ ИМЯ И Т. Д.</p>
                                <p class = "unselective" style = "color: #db4437; margin: 8px auto; width: 100%;">&nbsp;</p>
                                <p class = "unselective" style = "color: #db4437; margin: 8px auto; width: 100%;">ПРОДОЛЖАЯ ИСПОЛЬЗОВАТЬ ДАННЫЙ САЙТ (<a href = "https://jarvis.studio">https://jarvis.studio</a>) ВЫ АВТОМАТИЧЕСКИ ОБЯЗУЕТЕСЬ ПРИНЯТЬ ДАННЫЕ УСЛОВИЯ.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Подробнее о том как мы обрабатываем персональные данные вы можете узнать а <a href = "https://jarvis.studio/privacy">Политике конфиденциальности Teslasoft</a>.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Возможно эта статья покажеться вам странной, но согласно <span style = "color: #ffff00">Закону об обработке персональных данных ЕС (GDPR)</span>, вы должны быть уведомлены о том, какие именно действия выполняются на нашем сайте и о том какие именно данные мы собираем.</p>
                            </div>
