...
<html>
    <head>
        <meta charset = "utf-8">
        <title>Авторизация отменена (401)</title>
    ...
    <body>
		...
		<div class = "action-bar unselective">
		    ...
		    <b class = "activity-title">Авторизация отменена (401)</b>
		    <div class = "ssh">
                    ...
                    <div style = "margin: 16px auto;">
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            <div class="mdl-card__title" id = "card1bg">
                                <h2 class="mdl-card__title-text unselective">401</h2>
                            </div>
                            <div class="mdl-card__supporting-text">
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Авторизация отменена.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Для того, чтобы зайти сюда, необходимо авторизоваться.</p>
                            </div>
