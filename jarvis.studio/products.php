...
<html>
    ...
    <body>
		...
		<div class = "action-bar unselective">
		    ...
		    <b class = "activity-title">Наше API</b>
		    <div class = "ssh">
                    ...
                    <div style = "margin: 16px auto;">
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            <div class="mdl-card__title" id = "card5bg">
                                <h2 class="mdl-card__title-text unselective">Что вас интересует?</h2>
                            </div>
                            <div class="mdl-card__supporting-text">
                                <p>Мы предоставляем различное API для наших продуктов. Выберите интересующий вас продукт ниже.</p>
                                <p style = "color: #ffff00">Для использования нашего API необходиа последняя версия Jarvis Services. Вы можете найти ее на главной странице.</p>
                            </div>
                        </div>
                        <p>&nbsp;</p>
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            <div class="mdl-card__title" id = "api1bg" onclick = "javascript:api1()">
                                <h2 class="mdl-card__title-text unselective">Аккаунт Jarvis</h2>
                            </div>
                            <div class="mdl-card__supporting-text">
                                <p>Интегрируйте безопасный вход в аккаунт в вашем приложении.</p>
                            </div>
                            <div class="mdl-card__actions mdl-card--border" style = "z-index: 2; background-color: #323232;">
                                <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect unselective" style = "color: #db4437" onclick = "javascript:api1()">
                                    Перейти
                                </a>
                            </div>
                        </div>
                        <p>&nbsp;</p>
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            <div class="mdl-card__title" id = "api2bg" onclick = "javascript:api2()">
                                <h2 class="mdl-card__title-text unselective">Безопасность</h2>
                            </div>
                            <div class="mdl-card__supporting-text">
                                <p>Интегрируйте биометрическую авторизацию в вашем приложении.</p>
                            </div>
                            <div class="mdl-card__actions mdl-card--border" style = "z-index: 2; background-color: #323232;">
                                <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect unselective" style = "color: #db4437" onclick = "javascript:api2()">
                                    Перейти
                                </a>
                            </div>
                        </div>
                        <p>&nbsp;</p>
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            <div class="mdl-card__title" id = "api3bg" onclick = "javascript:void(0)">
                                <h2 class="mdl-card__title-text unselective">Teslasoft SmartCard</h2>
                            </div>
                            <div class="mdl-card__supporting-text">
                                <p>Teslasoft SmartCard позволяет входить в аккаунт пез паролей. Ключом безопасности является внешняя SD карта. Даже ели она потеряна или украдена злоумышленики не смогут войти в аккаунт.</p>
                                <p style = "color: #ff3d00">ВАЖНО! Этого API нет в свободном доступе. для его использования свяжитесь с нами.</p>
                            </div>
                            <div class="mdl-card__actions mdl-card--border" style = "z-index: 2; background-color: #323232;">
                                <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect unselective" style = "color: #db4437" onclick = "javascript:api3()">
                                    contact.teslasoft@gmail.com
                                </a>
                            </div>
                        </div>
                        <p>&nbsp;</p>
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            <div class="mdl-card__title" id = "api4bg" onclick = "javascript:api4()">
                                <h2 class="mdl-card__title-text unselective">Licence Manager</h2>
                            </div>
                            <div class="mdl-card__supporting-text">
                                <p>Лего проверяйте лицензию вашего приложения даже без подключения к Интернету. Выявляйте модифицировано ли ваше приложение.</p>
                            </div>
                            <div class="mdl-card__actions mdl-card--border" style = "z-index: 2; background-color: #323232;">
                                <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect unselective" style = "color: #db4437" onclick = "javascript:api4()">
                                    Перейти
                                </a>
                            </div>
                        </div>
	    ...
	    <script>
		    ...
		    function api1() {
		        window.location.assign("https://github.com/xXDima212DimaXx/jarvis-services");
		    }
		    ...
		    function api3() {
		        window.location.assign("mailto:contact.teslasoft@gmail.com");
		    }
