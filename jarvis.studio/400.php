...
<html>
    <head>
        <meta charset = "utf-8">
        <title>Чего-то здесь не хватает (400)</title>
    ...
    <body>
		...
		<div class = "action-bar unselective">
		    ...
		    <b class = "activity-title">Чего-то здесь не хватает (400)</b>
		    <div class = "ssh">
                    ...
                    <div style = "margin: 16px auto;">
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            <div class="mdl-card__title" id = "card1bg">
                                <h2 class="mdl-card__title-text unselective">400</h2>
                            </div>
                            <div class="mdl-card__supporting-text">
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Неполный запрос.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Пожалуйста проверьте адрес страницы, и повторите попытку.</p>
                            </div>
