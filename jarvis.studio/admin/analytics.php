...
<html>
    ...
    <body>
		...
		<div class = "action-bar unselective">
		    ...
		    <b class = "activity-title">Админка - аналитика</b>
		    <div class = "ssh">
                    ...
                    <div style = "margin: 16px auto;">
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            <div class="mdl-card__title" id = "card5bg">
                                <h2 class="mdl-card__title-text unselective">Google Analytics</h2>
                            </div>
...
gapi.analytics.ready(function() {
  ...
  gapi.analytics.auth.authorize({
    ...
    clientid: '1083710434382-9ij8jhfj4fg8p7l2ji9svjnb1l4bft4i.apps.googleusercontent.com'
  });
    ...
    dataChart.set({query: {ids: ids}}).execute();
	    ...
	    <script>
		    window.onload = function() {
		        ...
		        document.getElementById('card5bg').style.background = "url('https://jarvis.studio/res/images/img?id=card1_bg_webp') center / cover";
