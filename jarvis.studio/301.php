...
<html>
    <head>
        <meta charset = "utf-8">
        <title>Страница недоступна (301)</title>
    ...
    <body>
		...
		<div class = "action-bar unselective">
		    ...
		    <b class = "activity-title">Страница недоступна (301)</b>
		    <div class = "ssh">
                    ...
                    <div style = "margin: 16px auto;">
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            <div class="mdl-card__title" id = "card1bg">
                                <h2 class="mdl-card__title-text unselective">301</h2>
                            </div>
                            <div class="mdl-card__supporting-text">
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Было обнаружено слишком много перенаправлений.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Возможно необходимо поставить <span class = "unselective" style = "color: #db4437;">https://</span> в начале страницы. В целях безопасности мы не работаем с протоколом http.</p>
                            </div>
