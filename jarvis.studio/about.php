...
<html>
    ...
    <body>
		...
		<div class = "action-bar unselective">
		    ...
		    <b class = "activity-title">Jarvis | О проекте</b>
		    <div class = "ssh">
                    ...
                    <div style = "margin: 16px auto;">
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            ...
                            <div class="mdl-card__supporting-text">
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Jarvis - это проект, созданный организацией "Teslasoft", целью которого является создания идеальной версии искусственного интеллекта, а также разработка <a href="http://system.jarvis.studio">Системы</a> Jarvis для разных платформ.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Jarvis является свободным проектом, онако ПО с закрытым исходным кодом.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Если вы желаете ознакомиться с искусственным интеллектом и научиться разрабатывать нейронные сети, вы можете стать участником проекта. Дополнительно смотрите в статье <a href = "https://jarvis.studio/participate">Участие в проекте</a>.</p>
                            </div>
