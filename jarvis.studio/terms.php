                    ...
                    <div style = "margin: 16px auto;">
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            <div class="mdl-card__title" id = "card1bg">
                                <h2 class="mdl-card__title-text unselective">EULA</h2>
                            </div>
                            <div class="mdl-card__supporting-text">
                                <iframe src = "https://drive.google.com/viewerng/viewer?url=https://jarvis.studio/eula.pdf?pid=explorer&efh=false&a=v&chrome=false&embedded=true" width = "100%" height = "640px;"></iframe>
                            </div>
