...
if ($_GET['paid'] == "1") {
    ...
    $desc = "You can continue registration <a href = \"https://forms.gle/Ve6YXYBzNEDySU3x7\">by clicking here</a>.";
    $payment_link = "If we accept your request, you will be able to get e-passport";
} else {
    $title = "Teslasoft membership fee";
    $desc = "The membership fee is <a>\$3</a>. (Bank may charge additional fees depending of your payment method). By paying you accept <a href = \"https:\/\/jarvis.studio\/privacy\">Teslasoft Privacy</a> и <a href = \"https:\/\/www.paypal.com\/ua\/webapps\/mpp\/ua\/useragreement-full\">Legal Agrement of PayPal</a>";
    $payment_link = <<<EOL
    <div style = "padding: 16px; border-radius: 8px; background-color: #cecece; margin: auto;">
  ...
  <script src="https://www.paypal.com/sdk/js?client-id=sb&currency=USD&locale=en_US" data-sdk-integration-source="button-factory"></script>
  <script>
      ...
      paypal.Buttons({
        ...
        createOrder: function(data, actions) {
          return actions.order.create({
            purchase_units: [{"description":"Teslasoft Membership fee","amount":{"currency_code":"USD","value":3}}]
          });
        },
                    ...
                    <div style = "margin: 16px auto;">
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            <div class="mdl-card__title" id = "card1bg">
                                <h2 class="mdl-card__title-text unselective"></h2>
                            </div>
                            <div class="mdl-card__supporting-text">
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">$desc</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">$payment_link</p>
                            </div>
        ...
        <script>
            ...
            firebase.auth().onAuthStateChanged(function(user) {
                if (user) {
                    ...
                    document.getElementById("isLogged").innerHTML = "Logout";
                    isLogged = 1;

                } else {
                    document.getElementById("isLogged").innerHTML = "Login / Reqister";
                    isLogged = 1;
                }
            });
