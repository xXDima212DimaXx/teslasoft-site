...
<html>
    <head>
        <meta charset = "utf-8">
        <title>Jarvis | Дискорд сервер</title>
    ...
    <body>
		...
		<div class = "action-bar unselective">
		    ...
		    <b class = "activity-title">Jarvis | Дискорд сервер</b>
		    <div class = "ssh">
                    ...
                    <div style = "margin: 16px auto;">
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            <div class="mdl-card__title" id = "card5bg">
                                <h2 class="mdl-card__title-text unselective">Вам приглашение :)</h2>
                            </div>
                            <div class="mdl-card__supporting-text">
                                <iframe src="https://discord.com/widget?id=565206778426556426&theme=dark" width="350" height="500" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
                            </div>
