...
<html>
    <head>
        <meta charset = "utf-8">
        <title>Jarvis | Политика конфиденциальности</title>
    ...
    <body>
		...
		<div class = "action-bar unselective">
		    ...
		    <b class = "activity-title">Политика конфиденциальности</b>
		    <div class = "ssh">
                    ...
                    <div style = "margin: 16px auto;">
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            <div class="mdl-card__title" id = "card1bg">
                                <h2 class="mdl-card__title-text unselective">Политика конфиденциальности</h2>
                            </div>
                            <div class="mdl-card__supporting-text">
                                <p class = "unselective" style = "color: #ff3d00; margin: 8px auto; width: 100%;">В данном документе описано то как мы используем ваши персональные данные.</p>
                                <p class = "unselective" style = "color: #ffff00; margin: 8px auto; width: 100%;">Общие положения</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Мы - организация "Teslasoft".</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Ваши (личные/персональные) данные - все данные, которые вы нам предаете.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Наши сервисы - наш сайт и программное обеспечение.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Наш сайт - сайт, расположенный по адресу <a href = "https://jarvis.studio">https://jarvis.studio</a>.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Данный документ регулирует использование ваших данных, и публикацию таких данных вами в наших службах.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Действия данного документа не распространяется на третих лиц.</p>
                                <p class = "unselective" style = "color: #ffff00; margin: 8px auto; width: 100%;">Какие данные мы используем и для чего?</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Ваш адрес электронной почты - для подтверждения аккаунта и обратной связи.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Пароль от аккаунта (он хранится в зашифрованном виде и у нас нет доступа к нему) - для обеспечения безопасности аккаунта.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Ваше имя пользователя - для того, чтобы ваш аккаунт смогли найти другие и обратной связи.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Изображение профиля (аватар) - для того, чтобы ваш аккаунт смогли найти другие.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • При регистрации вашему аккаунту присваевается уникальный идентификатор (Account ID) - для идентификации аккаунта.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Дата рождения (необязательный параметр) - У некоторых наших сервисов установлены возрастные ограничения.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Ваше Имя и фамилия - Для участия в проекте мы должны знать ваши контактные данные.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Номер телефона - Для участия в проекте мы должны знать ваши контактные данные.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • IP-адрес (является стандартным параметром для идентификации вашего компьютера) - обеспечение безопасности и защиты от ботов и спама. Мы не используем IP в целях аналитики.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Ваше месторасположение (ТОЛЬКО СТРАНУ) - в некоторых странах могут быть недоступны наши сервисы.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Для участия в проекте вам понадобиться код приглашения.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Резюме - Для участия в проекте.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Аналитика и персонализация (Вы автоматически принимаете <a href = "https://policies.google.com/privacy?fg=1">Политику конфиденциальности и Условия использования Google</a> и <a href = "https://www.jivosite.ru/files/personal_data_processing_policy.pdf">Политику обработки персональных данных Jivosite</a>) - мы используем стороннее программное обеспечение для аналитики, персонализации и обратной связи.</p>
                                <p class = "unselective" style = "color: #ffff00; margin: 8px auto; width: 100%;">Где мы храним ваши данные?</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Мы храним ваши данные в защищенной базе данных Firebase.</p>
                                <p class = "unselective" style = "color: #ffff00; margin: 8px auto; width: 100%;">Ваши права и обязанности</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Вы имеете право запросить изменение/удаление своих данных.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Вы имеете право запросить изменение/удаление чужих данных если они нарушают законодательство.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Вы предоставляете нам право обрабатывать ваши данные и предоставляете нам неисключительную, действующую во всем мире лицензию на хранение/изменение/удаление/распространение ваших данных в рамках нормальной работы наших сервисов а также аналитики и персонализации (Нормальной работай называется обработка данных в целях, указанных выше).</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Вы не имеете права обходить стандартный интерфейс в целях похищения/изменения/удаления/распространения данных пользователей.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Вы несете полную ответственность за ваши данные.</p>
                                <p class = "unselective" style = "color: #ffff00; margin: 8px auto; width: 100%;">Наши права и обязанности</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Мы имеем право изменять данные условия.</p>
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp; • Мы имеем право в любой момент удалить/изменить ваши данные если из-за ваших данных нашим сервисам угрожает ответственность по закону.</p>
        ...
        <script>
            ...
            function toLogin() {
                if (isLogged == 1) {
                    ...
                    window.location.assign("https://jarvis.studio/login/oauth?continue=https://jarvis.studio/about");
                }
		    }
		    ...
		    function signOut() {
                ...
                window.location.replace("https://jarvis.studio/login/oauth?continue=https://jarvis.studio/about");
            }
        </script>
	    <script>
		    window.onload = function() {
		        ...
		        setTimeout(function() {
		            ...
		            document.getElementById('card1bg').style.background = "url('https://jarvis.studio/res/images/img?id=card6_bg_webp') center / cover";
		        }, 500);
		    };
