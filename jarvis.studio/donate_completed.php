...
<html>
    <head>
        <meta charset = "utf-8">
        <title>Благодарим вас за поддержку</title>
    ...
    <body>
		...
		<div class = "action-bar unselective">
		    ...
		    <b class = "activity-title">Благодарим вас за поддержку</b>
		    <div class = "ssh">
                    ...
                    <div style = "margin: 16px auto;">
                        <div class="main-card-wide mdl-card mdl-shadow--2dp unselective" style = "text-align: left; margin: auto;">
                            ...
                            <div class="mdl-card__supporting-text">
                                <p class = "unselective" style = "color: #afafaf; margin: 8px auto; width: 100%;">Благодаря вашей поддержке мы создаем и развиваем новые сервисы.</p>
                            </div>
